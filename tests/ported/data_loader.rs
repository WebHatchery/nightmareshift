...
fn localization_carries_no_undrawable_glyphs() {
    let json = macroquad_toolkit::include_json_str!(concat!(
...
fn displayed_source_text_carries_no_undrawable_glyphs() {
    ...
    const SOURCES: [(&str, &str); 8] = [
        (
            "ui/components.rs",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/ui/components.rs")),
        ),
        (
            "data/passenger.rs",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/data/passenger.rs"
            )),
        ),
        (
            "data/event.rs",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/data/event.rs")),
        ),
        (
            "screens/game_screens/dossier.rs",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/screens/game_screens/dossier.rs"
            )),
        ),
        (
            ...
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/screens/game_screens/guidelines.rs"
            )),
        ),
        (
            ...
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/screens/game_screens/dropoff.rs"
            )),
        ),
        (
            ...
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/screens/game_screens/interaction.rs"
            )),
        ),
        (
            ...
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/src/screens/game_screens/modals.rs"
            )),
        ),
    ];
